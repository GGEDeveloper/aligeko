...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    try {
      ...
      const indices = await queryInterface.showIndex('carts');
      const indexExists = indices.some(idx => idx.name === 'idx_carts_user_id');
      ...
      // Só adiciona o índice se ele não existir
      if (!indexExists) {
      ...
      if (error.message.includes('already exists')) {
        console.log('Uma ou mais tabelas ou índices já existem, continuando...');
      } else {
        throw error;
      }
    }
